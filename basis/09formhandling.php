...
<form action="09create.php" method="post">
...
<div class="col-sm-10">
<input type="text" class="form-control form-control-sm" id="colFormLabel" name="txtadd" placeholder=" Enter Your Address ">
</div>
</div>
<div class="form-group row">
...
<input type="submit"  class="btn btn-success" id="colFormLabel" name="save" value="save data" >
</form>
</div>
