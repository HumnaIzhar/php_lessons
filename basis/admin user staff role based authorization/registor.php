...
<body>
    <form class="container card card-body mt-5" style="width:70%" action="registorinsert.php" method="post">
        <center>
        <h4 class="bg-warning text-white">Registor here</h4>
        </center>
    ...
    <div class="col-sm-10">
    <input type="number" name="age" min="0" class="form-control form-control-sm" id="colFormLabel" placeholder=" Enter Your age ">
    </div>
    </div>
    <div class="form-group row">
    <label for="colFormLabel" class="col-sm-2 col-form-label col-form-label">Address</label>
    <div class="col-sm-10">
    <input type="text" name="address" class="form-control form-control-sm" id="colFormLabel" placeholder=" Enter Address ">
    </div>
    </div>
    <div class="form-group row">
  ...
  <center>
    <button type="submit" class="btn btn-secondary form-control"> Register Here</button>
    <a href="login.php" class="text-success">Alreday an member login here......</a>
  </center> 
    </form>
